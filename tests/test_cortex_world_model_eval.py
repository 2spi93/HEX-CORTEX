...
def test_candidate_can_be_promoted_when_it_improves_without_regression() -> None:
    ...
    assert result["next_action"] == "prepare_candidate_promotion"


def test_candidate_is_retained_when_one_required_metric_regresses() -> None:
    result = evaluate_world_model_candidate(
        baseline={
            "prediction_error": 0.20,
            "surprise_calibration": 0.70,

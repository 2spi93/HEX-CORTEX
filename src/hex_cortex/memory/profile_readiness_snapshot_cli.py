"""CLI for profile readiness snapshots."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="profile-readiness-snapshot")
    ...
    if args.summary:
        payload = summarize_profile_readiness_snapshots(args.profile / SNAPSHOT_FILENAME)
    else:
        payload = record_profile_readiness_snapshot(
            args.profile,

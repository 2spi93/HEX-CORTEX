...
_OUTPUTS = [
    ...
    },
    {
        ...
        "label": "Generation de scene 3D",
        "state": "candidate",
        "requires_operator": False,
        "raw_input_persistence_allowed": False,
    },
    {
        "output_id": "render_3d_asset",
        "label": "Rendu d'asset 3D",
        "state": "candidate",
        "requires_operator": False,
        "raw_input_persistence_allowed": False,
    },
    ...
    {
        "output_id": "publish_social_content",
        "label": "Publication sur reseau social",
        "state": "candidate",
        "requires_operator": True,
        "raw_input_persistence_allowed": False,
    },
    {
        "output_id": "manage_social_inbox",
        "label": "Gestion de boite sociale",
        "state": "candidate",
        "requires_operator": True,
        "raw_input_persistence_allowed": False,
    },
